...
set_property  -dict {PACKAGE_PIN B5  IOSTANDARD LVCMOS33}  [get_ports {qsfp0_channel_up   }] ;# LED 0
set_property  -dict {PACKAGE_PIN A5  IOSTANDARD LVCMOS33}  [get_ports {qsfp0_sys_reset_out}] ;# LED 1
set_property  -dict {PACKAGE_PIN A4  IOSTANDARD LVCMOS33}  [get_ports {led_heartbeat      }] ;# LED 2
set_property  -dict {PACKAGE_PIN C5  IOSTANDARD LVCMOS33}  [get_ports {qsfp1_channel_up   }] ;# LED 3
set_property  -dict {PACKAGE_PIN C6  IOSTANDARD LVCMOS33}  [get_ports {qsfp1_sys_reset_out}] ;# LED 4
